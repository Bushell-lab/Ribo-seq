...
#We first align to rRNA, then use everything that did not align to rRNA as input to align to tRNAs and then protein coding mRNAs. We then use fastQC on all the output <.fastq> files
